...
const sliderOverlays = [
  ...
  },
  {
    ...
    showTrailer: false,
    subtitle:
      "তুই যে আমার নয় | Papon | Tui Je Amar Noy | The Red Files | Taniqsha R | Abhirup C | Bangla Gaan",
    details:
      "Title: Tui Je Amar Noy Singer: Papon Music Director: Soumya Rit Lyricist: Soumya Rit Featuring Starcast: Taniqsha Roy & Abhirup Chowdhury",
  },
  {
    ...
    showTrailer: false,
    subtitle:
      "Bondhu Dekha Hobe | Nachiketa Chakraborty | The Red Files | Mumtaz | Kinjal",
    details:
      "Title: Bondhu Dekha Hobe Singer: Nachiketa Chakraborty Music Director: The Red Files Featuring Starcast: Mumtaz & Kinjal",
  },
];
...
export default function HomePage() {
  ...
  const films = [
    {
      ...
      description:
        "Two co-workers battle it out over Google Meet—only to find love hidden in emojis, memes, and missed deadlines.",
    ...
    },
    {
      ...
      description:
        "Two strangers miss their trains, share jhalmuri on a foggy platform, and discover that sometimes a missed train takes you to the right destination.",
      tags: ["45 Mins Movie", "Romance"],
    },
    {
      ...
      duration: "30-40 minutes",
      description:
        "Aniket accidentally sends a Facebook message to Mallika — only to discover they were classmates in the same school but never once crossed paths.",
      tags: ["45 Mins Movie", "Romance"],
    },
    {
      ...
      duration: "30-40 minutes",
      description:
        "Old rivals, a school play, and a village soaked in nostalgia — where childhood banter turns into grown-up blushes.",
      tags: ["45 Mins Movie", "Romance"],
    },
    {
      ...
      description:
        "When a cartoonist loses his words, he finds them again in the colors of silence. A story where love is drawn, not spoken.",
      tags: ["45 Mins Movie", "Romance"],
    },
    {
      ...
      duration: "35 minutes",
      description:
        "Love, like chotpoti, is best when it burns just a little. One street vendor's charm meets a no-nonsense law student—and sparks fly with every bite.",
      tags: ["45 Mins Movie", "Romance"],
    },
    {
      ...
      description:
        "A quirky girl. A delivery boy. Countless online orders… and one accidental love story that clicks right where it matters— the heart.",
      tags: ["45 Mins Movie", "Romance"],
    },
  ];
  ...
  const redFilesIndex = sliderImages.findIndex((src) =>
    src.includes("The-Red-Files-2024"),
  );
  ...
  return (
    <div className="flex flex-col bg-black">
      ...
      {showPiP && (
        ...
        >
          <div
            className="relative w-[90vw] max-w-xl aspect-video bg-black rounded-xl overflow-hidden shadow-2xl"
                ...
                >
                  ...
                  {sliderOverlays[idx].showRating && (
                    ...
                    >
                      ...
                      <span className="text-white text-base font-bold ml-2">
                        {sliderOverlays[idx].rating}
                      </span>
                      <span className="bg-yellow-400 text-black font-bold px-2 py-1 rounded text-xs ml-2">
                        IMDb
                      </span>
                      <span className="text-white text-base ml-4">
                        ⏱ {sliderOverlays[idx].duration}
                      </span>
                    </motion.div>
                  )}
                  {sliderOverlays[idx].stars && (
                    ...
                    >
                      ...
                      <span className="text-red-400 text-base font-semibold ml-2">
                        {sliderOverlays[idx].stars}
                      </span>
                    </motion.div>
                  )}
                  ...
                  >
                    <Link
                      href={`${sliderOverlays[idx].stars?.includes("Singer:") || sliderOverlays[idx].details?.includes("Singer:") ? "/music-videos" : "/movies"}/${toSlug(sliderOverlays[idx].title)}`}
      ...
      >
        ...
        <div className="w-full flex flex-col md:flex-row items-center justify-center gap-8 max-w-6xl mx-auto">
          ...
          >
            ...
            >
              Title: The Red Files (2024)
              <br />
              Genre: Thriller
              <br />
              Based on: The true event of the Bantala Rape Case in the 1990s,
              West Bengal
              <br />
              IMDb: 8.5/10
            </motion.div>
      ...
      <section className="w-full bg-black py-12 flex flex-col items-center">
        ...
        <div className="w-full flex items-center justify-center">
          <div
            className="bg-zinc-900 text-white text-xl font-semibold rounded-lg px-8 py-6 border border-red-500"
            style={{ minWidth: 300 }}
          >
            No Data Found
          </div>
      ...
      <section className="w-full bg-black py-12 flex flex-col items-center">
        <h2 className="text-4xl md:text-5xl font-bold text-white mb-8 text-left w-full max-w-7xl px-4">
          Music Video
        </h2>
        <div
          className="w-full max-w-7xl flex justify-start items-center gap-8 px-4 relative"
  ...
  return (
    <div className="w-full max-w-7xl px-4">
      <div className="relative">
        ...
        <div className="relative border border-red-500 rounded-3xl p-8 shadow-2xl transition-all duration-700 overflow-hidden">
          <img
...
function FeaturedMoviesVertical({
  movies,
  onMovieChange,
}: {
  movies: {
  ...
  const start = Math.max(
    0,
    Math.min(selected - 1, movies.length - visibleCount),
  );
    ...
    <div className="w-full flex flex-row gap-8 items-center justify-center relative min-h-[420px]">
      ...
      <div className="flex flex-col gap-4 items-center relative z-10">
        ...
        <button
          ...
          onClick={() =>
            handleMovieSelect(Math.min(movies.length - 1, selected + 1))
          }
          ...
          >
            ...
            >
              {movies[selected].title === "The Red Files" && (
                <>
                  <span className="bg-yellow-400 text-black font-bold px-2 py-1 rounded text-xs">
                    IMDb
                  </span>
                  <span className="text-white text-lg font-semibold">
                    {movies[selected].imdb || "8.5"}
                  </span>
                </>
              )}
            </motion.div>
            ...
            >
              {movies[selected].description ||
                "Genre: Romantic Drama | Language: Bengali | Duration: 30–35 minutes Status: Upcoming | Studio: Blueberries Originals. When a cartoonist loses his words, he finds them again in the colors of silence..."}
            </motion.div>
            {/* Tags */}
            <motion.div
            ...
            >
              {movies[selected].tags &&
                movies[selected].tags.map((tag, index) => (
                  <motion.span
                    key={index}
...
function AnimatedWatchTrailerButton({
  setShowPiP,
}: {
  ...
  return (
    ...
    >
      ...
      <span className="text-white text-xl font-semibold tracking-widest group-hover:text-white transition-colors duration-300">
        WATCH TRAILER
      </span>
    </button>
  );
